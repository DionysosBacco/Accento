...
public:
    ...
    void cursor(glm::vec2 p1, glm::vec2 p2, glm::vec2 p3);
    void moveCursor(glm::vec2 p1);
    void cursorDraw();
    std::vector<std::pair<float, float>> computeCoordinates();
...
private:
    ...
    int width, height;
    ofPath path;
    Time2GraphicMap _outmap;
    Time2GraphicMap _outmap_2;
